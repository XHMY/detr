...
export OUTPUT_DIR=outputs/r101_lora_v2_qv_train_street_work
mkdir -p $OUTPUT_DIR
python -m torch.distributed.launch --nproc_per_node=2 --use_env main.py \
--lr_drop 500 --epochs 1000 --eval_interval 40 \
--hf_model facebook/detr-resnet-101 \
--lora --target_modules fc1 --modules_to_save model.backbone class_labels_classifier bbox_predictor model.input_projection \
